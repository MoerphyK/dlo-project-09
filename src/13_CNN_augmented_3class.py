...
## PATHs
MODEL_PATH = "cnn_13_augmented_3class.pth"
DATA_PATH = "../assets/augmented3/"
PLOT_PATH = "../docs/test_results/13_augmented_3class_plot.png"
TXT_PATH = "../docs/test_results/13_augmented_3class.txt"
