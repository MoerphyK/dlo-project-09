...
## PATHs
MODEL_PATH = "cnn_12_baseline_3class.pth"
DATA_PATH = "../assets/baseline3/"
PLOT_PATH = "../docs/test_results/12_baseline_3class_plot.png"
TXT_PATH = "../docs/test_results/12_baseline_3class.txt"
